ALTER TABLE public.store_daily_metrics
  ADD COLUMN IF NOT EXISTS meta_mix numeric DEFAULT 0,
  ADD COLUMN IF NOT EXISTS realizado_mix numeric DEFAULT 0,
  ADD COLUMN IF NOT EXISTS projecao_mix numeric DEFAULT 0;
...
BEGIN
  ...
  RETURN QUERY
  WITH base AS (
    -- NULL (e nao zero) quando nao ha historico: assim o fallback pela media do dia funciona
