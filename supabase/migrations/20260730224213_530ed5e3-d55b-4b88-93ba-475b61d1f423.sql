...
BEGIN
  ...
  prep AS (
    ...
    SELECT DISTINCT ON (ref) * FROM prep WHERE ref IS NOT NULL
  ), classif AS (
    SELECT p.*,
...
SELECT * FROM public.importar_lancamentos_vr(
  '0b7759de-0143-4a80-8be4-6cf62b2c98c3'::uuid, '2026-06-01'::date, '2026-07-31'::date);